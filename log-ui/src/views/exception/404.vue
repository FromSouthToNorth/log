  ...
  <section class="hy-section hy-section_bg_gray-light">
    ...
    C360.647,451.083,349.251,457.661,338.164,454.689z"/>
      ...
      s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z"/>
        ...
        <div class="hy-col-6 hy-col-md-12 hy-offset-top-48">
          <h1 class="hy-h1">404</h1>
          <h2 class="hy-h2 hy-offset-top-48">UH OH! You're lost.</h2>
          <p class="hy-offset-top-48">您正在查找的页面不存在。你是怎么到这里来的是个谜。但是你可以点击下面的按钮回到主页。</p>
          <router-link to="/" class="hy-btn hy-color_green hy-offset-top-48" tag="button">
            HOME
          </router-link>
        </div>
      </div>
...
:root {
  --hy-color-blue: #0e0620;
  --hy-color-white: #fff;
  --hy-color-green: #2ccf6d;
}
...
.hy-btn {
  ...
  &.hy-color_green {
    border: 4px solid var(--hy-color-green, #2ccf6d);
    color: var(--hy-color-blue, #0e0620);
    ...
    &:before {
      ...
      width: 0%;
      height: 100%;
      background: var(--hy-color-green, #2ccf6d);
      z-index: -1;
      transition: .2s ease;
    }

    &:hover {
      color: var(--hy-color-white, #fff);
      background: var(--hy-color-green, #2ccf6d);
      transition: .2s ease;
